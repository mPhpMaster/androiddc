...
| `Ftp` | Workspace | FTP tab and header control | `Restore-FtpPage`, `Set-FtpHeaderState`, `Update-FtpHeader`, `Invoke-FtpHeaderToggle`, `Update-FtpAddress`, `Update-FtpPage`, `Invoke-NovaFtpAction`; server operations are shared in `..\shared\Ftp.ps1` |
